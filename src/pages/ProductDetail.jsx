    ...
    <Container className="py-8">
      ...
      <div className="grid md:grid-cols-2 gap-6 md:gap-8 lg:gap-12">
        ...
        <div className="flex gap-5 shrink-0 ">
          {/* Thumbnails */}
          <div className="flex flex-col gap-6 w-[67px] shrink-0">
            {images.map((img, idx) => (
              <button
                key={idx}
        ...
        <div className="space-y-4 sm:space-y-6">
            ...
            <div className="flex gap-2">
              {product.colors?.map((color, idx) => (
                <button
                  ...
                  className={`w-10 h-10 rounded-full border-2 ${selectedColor === idx ? 'border-blue-500' : 'border-gray-200'
                    }`}
            ...
            <div className="flex gap-2">
              {product.sizes?.map((size, idx) => (
                <button
                  ...
                  className={`px-4 py-2 border ${selectedSize === idx
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              className="flex-1 bg-blue-500 hover:bg-blue-600 text-white font-medium py-3 transition-colors"
            >
              Add to cart
            </button>
          </div>
