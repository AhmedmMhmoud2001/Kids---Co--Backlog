  ...
  return (
    <div className="container mx-auto px-4 sm:px-6 md:px-10 lg:px-20 py-8">
      <div className="max-w-6xl mx-auto">
        <h1 className="text-2xl sm:text-3xl font-bold mb-4 sm:mb-6">Our Brands</h1>
        ...
        <div className="bg-blue-50 rounded-lg p-8 text-center">
          ...
          <p className="text-gray-700 mb-6">
            Explore our complete collection of products from these amazing brands and more.
          </p>
          <Link
            to="/shop"
        ...
        <div className="mt-12">
          <h2 className="text-2xl font-semibold mb-4">Why Choose Our Brands?</h2>
          <div className="grid md:grid-cols-3 gap-6">
            <div className="text-center">
              ...
              <p className="text-gray-600">All products are 100% authentic and sourced directly from authorized distributors.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">We ensure every product meets our high standards for quality and craftsmanship.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Competitive pricing with regular sales and special offers.</p>
            </div>
          </div>
        </div>
      </div>
